...
export default function Scheme() {
  return (
    <article class="space-y-4 text-label-sm">
      <section class="flex flex-1 self-stretch">
        {/* Top row */}
        <div class="flex">
          <div class="space-y-1">
            {/* Primary */}
      ...
      <section class="grid gap-1">
        {/* Bottom Row */}
        <div class="grid grid-flow-col text-light-on-surface dark:text-dark-on-surface">
          {/* Surfaces */}
          <Swatch
            role="Surface Dim"
            token="n-87"
        ...
        <div class=" text-light-on-surface">
